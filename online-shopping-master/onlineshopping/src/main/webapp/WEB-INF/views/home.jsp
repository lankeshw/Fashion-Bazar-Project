					...
					<div id="carousel-example-generic" class="carousel slide"
						...
						<div class="carousel-inner">
							...
							<div class="item active">
								<img class="slide-image" src="${images}/adidas%20football%20shoes.jpg"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/vector.png"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/football-soccer.jpg"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/iphone.jpg"
									alt="">
							</div>
						</div>
